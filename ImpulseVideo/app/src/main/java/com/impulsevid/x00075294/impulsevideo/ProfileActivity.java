...
/***************************************************************************************
 *    Title: How to Use Client Library
 *    Author: Microsoft
 *    Date: 13/7/17
 *    Code version: 1.0
 *    Availability: https://docs.microsoft.com/en-us/azure/app-service-mobile/app-service-mobile-android-how-to-use-client-library#query
 *
 ***************************************************************************************/
public class ProfileActivity extends AppCompatActivity {
    ...
    class uploadProfilePhoto extends AsyncTask<Profile, Void, Void> {
        final SharedPreferences prefs = getSharedPreferences(LaunchActivity.SHAREDPREFFILE, Context.MODE_PRIVATE);
        String profileId = prefs.getString(LaunchActivity.USERIDPREF, null);
        String profUrl;
        ProgressDialog pd;
